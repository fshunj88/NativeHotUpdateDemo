class HotUpdateHelper {
    private static _inst: HotUpdateHelper = null;
    public panel: any;
    private _am: any;
    private _checkListener: any;
    private _updating: boolean;
    private _manifestUrl: any;
    private _canRetry: any;
    private _updateListener: any;
    private _failCount: any;
    private _storagePath: any;
    private _versionCompareHandle: any;
    public static get inst(): HotUpdateHelper {
        if (this._inst == null) {
    ...
    private _checkCb(event: any) {
        //event.getEventCode()对应的枚举在C++层中定义
    ...
    public updateCb(event) {
        ...
        switch (event.getEventCode()) {
            ...
            case jsb.EventAssetsManager.UPDATE_FINISHED:
                //C++层更新完成后，会分发UPDATE_FINISHED信息，从而回调到这里
...
//    // use this for initialization
//    onLoad: function () {
//        console.log("onLoad called in hotupdate.js");
//        this.panel = cc.find("Canvas/update_panel").getComponent("UpdatePanel");
//        // Hot update is only available in Native build
//        cc.loader.loadRes("project", cc.Asset, function (err, asset) {
//            this.manifestUrl = asset;
//            console.log("loaded this.manifestUrl:", asset);
//        }.bind(this));
//        if (!cc.sys.isNative) {
//            return;
//        }
...
//fshunj.oss-cn-guangzhou.aliyuncs.com
//var customManifestStr = JSON.stringify({
//    "packageUrl": "http://fshunj.oss-cn-guangzhou.aliyuncs.com/tutorial-hot-update/remote-assets/",
//    "remoteManifestUrl": "http://fshunj.oss-cn-guangzhou.aliyuncs.com/tutorial-hot-update/remote-assets/project.manifest",
//    "remoteVersionUrl": "http://fshunj.oss-cn-guangzhou.aliyuncs.com/tutorial-hot-update/remote-assets/version.manifest",
//    "version": "1.10",
//    "assets": {
//        "src/cocos2d-jsb.js": {
//            "size": 3341465,
